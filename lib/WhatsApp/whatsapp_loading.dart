      ...
      children: [
        Text(
          ...
          style: GoogleFonts.inter(
            ...
            height: 1,
            letterSpacing: -1,
            color: WhatsappLoading.primaryColor,
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: GoogleFonts.inter(
              fontSize: 24,
              color: WhatsappLoading.secondaryColor,
...
class _BottomActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BottomAppBar(
      color: WhatsappLoading.thirdColor,
      height: 80,
      child: Row(
        children: [
          Expanded(
            child: ElevatedButton(
              onPressed: () =>
                  Navigator.push(context,
                      MaterialPageRoute(builder: (_) => const WhatsappMain())),
              style: ElevatedButton.styleFrom(
                backgroundColor: WhatsappLoading.primaryColor,
          ...
          GestureDetector(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                color: const Color(0xff1877D7).withOpacity(0.9),
